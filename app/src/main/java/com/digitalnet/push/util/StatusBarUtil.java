...
public class StatusBarUtil {
    ...
    public static int getStatusBarHeight() {
        int result = 0;
        int resourceId = BaseApplication.mBaseApplication.getResources().getIdentifier("status_bar_height", "dimen", "android");
        if (resourceId > 0) {
            result = BaseApplication.mBaseApplication.getResources().getDimensionPixelSize(resourceId);
        }
        return result;
    }
}
